...
- 仓库：**https://github.com/KevinTse777/OpenAltTab**（public，SSH 远端 `origin` 已配置并跟踪）
- `main` 与 `v1.3.0` tag 均已推送；后续发版流程：`git tag vX.Y.Z && git push origin vX.Y.Z`
- gh CLI 已重新登录（KevinTse777，keyring，scopes: repo）；2026-09-17 经 GitHub 设备授权流程完成重认证
